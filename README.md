...
Third parties are able to connect to the CDS site from their own websites using the CDS (Wordpress) API https://maps.transitionnetwork.org/api/ to obtain initiative data for a hub.
