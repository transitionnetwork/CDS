<ul class="button-group">
  ...
  <?php } else { ?>
    <li>
      ...
      <a class="btn btn-outline" href="<?php echo get_the_permalink(459); ?>"><?php echo svg('key'); ?><?php _e('Sign in', 'tofino'); ?></a>
      <span class="mx-1">
        <?php _e('or', 'tofino'); ?>
      </span>
      <a class="btn btn-outline" href="<?php echo get_the_permalink(460); ?>"><?php echo svg('key'); ?><?php _e('Register', 'tofino'); ?></a>
    </li>
  <?php } ?>
